...
<div class="container">
	<div class="row">
		<div class="col-sm-12 col-md-4 catLojas">
			...
			<a href="/pisos_loja/piso-p2/">
				<li class="pisos">Piso P2</li></a>
			<a href="/pisos_loja/terreo/">
				<li class="pisos">Piso Térreo</li></a>
			<a href="/pisos_loja/1o-piso/">
				<li class="pisos">1º Piso</li></a>

			<h3>CATEGORIAS:</h3>
			<?php $terms = get_terms( array( 
				'taxonomy' => 'categorias_lojas'
			) );
